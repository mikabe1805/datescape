    ...
    <div className="full-landing-wrapper">
      <div className="landing-container">
        ...
        <div className="about">
          <h2>About Us</h2>
          <p>
            DateScape is more than a dating app. It is a place to explore new connections in a virtual open world.
            Whether you are looking for love or friendship, you will find meaningful interactions through shared experiences,
